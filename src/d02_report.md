...
1. откатить 11 назад
2. переделать конфиг, как на последнем скрине в папке
3. включить дхцп н р1
4. ребут 11
5. проверить, что ничего сработало
6. сделать скрин
7. написать, что не сработало
8. прописать мак адрес в вб, сделать скрин
9. описать в отчёте
10. сделать ребут 11
11. должно заработать
