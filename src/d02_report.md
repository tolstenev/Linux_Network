...
- сделать скриншот с Listen localhost:80
- открыть порт на р1 на нат
- включить на дхцп
- удалить первый путь, чтобы инет заработал
- установить openssh-server
- запустить ремоут доступ на 22 машину
- если всё ок, скринить
- почитать, что нужно описать в отчёте, и описать